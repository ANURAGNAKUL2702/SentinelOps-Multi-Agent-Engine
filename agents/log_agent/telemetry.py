...
def get_logger(name: str = "log_agent") -> logging.Logger:
    """Return a JSON-formatted logger.

    Example::

        log = get_logger("log_agent.signal_extractor")
        log.info("Extraction complete", extra={"correlation_id": cid, "layer": "deterministic"})
    """
...
class TelemetryCollector:
    """Collects metrics for all layers of the log agent pipeline.
    ...
    def __init__(self) -> None:
        self._log = get_logger("log_agent.telemetry")
    ...
    def measure(
        ...
        Args:
            layer: One of 'extraction', 'anomaly_detection',
    ...
    def snapshot(self) -> Dict[str, Any]:
        ...
        Example::
            ...
            # {
            #   "latency": {"extraction": {"count":5, "avg":12.3, ...}, ...},
            #   "counters": {"analyses_total": 5, ...},
            # }
        """
        return {
